...
train_df = read_in_file("time_and_temp/train_dataset_tt_no_stochastic.txt")
...
function solve_QLearning(df, model)
    ...
    writedlm("time_and_temp/policies/q_learning-01-tt.txt", actions)
    return actions
end
...
function solve_Sarsa(df)
    ...
    writedlm("time_and_temp/policies/sarsa-01-tt.txt", actions)
    return actions
end
...
savefig("time_and_temp/graphs/time_and_temp_gph.png")   

make_heatmap_full(q_dict, 1, 1, "time_and_temp/graphs/heatmap_q_learning_1")
make_heatmap_full(q_dict, 1, 2, "time_and_temp/graphs/heatmap_q_learning_2")
make_heatmap_full(q_dict, 2, 1, "time_and_temp/graphs/heatmap_q_learning_3")
make_heatmap_full(q_dict, 2, 2, "time_and_temp/graphs/heatmap_q_learning_4")
make_heatmap_full(sarsa_dict, 1, 1, "time_and_temp/graphs/heatmap_sarsa_1")
make_heatmap_full(sarsa_dict, 1, 2, "time_and_temp/graphs/heatmap_sarsa_2")
make_heatmap_full(sarsa_dict, 2, 1, "time_and_temp/graphs/heatmap_sarsa_3")
make_heatmap_full(sarsa_dict, 2, 2, "time_and_temp/graphs/heatmap_sarsa_4")
